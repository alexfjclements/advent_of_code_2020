def list_builder(str_input):
    input_list = str_input.split('\n')

    input_list_ints = []
    for element in input_list:
        input_list_ints.append(element)

    return input_list_ints

data = """1-8 n: dpwpmhknmnlglhjtrbpx
